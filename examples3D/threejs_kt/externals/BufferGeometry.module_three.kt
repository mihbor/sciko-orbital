...
external open class BufferGeometry : EventDispatcher {
    open var id: Number
    open var uuid: String
    open var name: String
    open var type: String
    open var index: BufferAttribute?
    open var attributes: `T$45`
    open var morphAttributes: `T$46`
    open var morphTargetsRelative: Boolean
    open var groups: Array<`T$47`>
    open var boundingBox: Box3?
    open var boundingSphere: Sphere?
    open var drawRange: `T$48`

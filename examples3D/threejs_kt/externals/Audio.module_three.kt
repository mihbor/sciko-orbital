...
import tsstdlib.AudioBufferSourceNode
import tsstdlib.MediaStream
import tsstdlib.AudioNode

external open class Audio<NodeType : AudioNode>(listener: AudioListener) : Object3D {
    ...
    open fun load(file: String): Audio__0
}

external open class Audio__0 : Audio<GainNode>
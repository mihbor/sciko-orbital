...
external interface AudioContext : BaseAudioContext {
    ...
    companion object : AudioContext by definedExternally
}
...
external interface ReadableStream<R> {
    ...
    fun getReader(options: `T$38`): ReadableStreamBYOBReader
    fun getReader(): ReadableStreamDefaultReader<R>
    fun <T> pipeThrough(__0: `T$39`<R, T>, options: PipeOptions = definedExternally): ReadableStream<T>
...
external interface XPathEvaluatorBase {
    ...
    fun createExpression(expression: String, resolver: `T$40`? = definedExternally): XPathExpression
    fun createNSResolver(nodeResolver: Node): dynamic /* (prefix: String?) -> String? | `T$40` */
    ...
    fun evaluate(expression: String, contextNode: Node, resolver: `T$40`? = definedExternally, type: Number = definedExternally, result: XPathResult? = definedExternally): XPathResult
    fun evaluate(expression: String, contextNode: Node, resolver: `T$40`? = definedExternally): XPathResult
    fun evaluate(expression: String, contextNode: Node, resolver: `T$40`? = definedExternally, type: Number = definedExternally): XPathResult
}
